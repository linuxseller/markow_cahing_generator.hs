...
/* package markow-chgen-0.1.0.0 */
#ifndef VERSION_markow_chgen
#define VERSION_markow_chgen "0.1.0.0"
#endif /* VERSION_markow_chgen */
#ifndef MIN_VERSION_markow_chgen
#define MIN_VERSION_markow_chgen(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_markow_chgen */
...
#define CURRENT_COMPONENT_ID "markow-chgen-0.1.0.0-inplace-markow-chgen"
